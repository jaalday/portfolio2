...
const Petmd = () => {
  return (
    <div className="container3">
        <div className="pet1"><h1 className="title">Pet MD</h1>
        ...
        <div className="pet2">dlfgjdh
        <img
            className="imgpet"
            src="https://i.postimg.cc/QdrLcFWK/Screen-Shot-2024-06-05-at-1-46-01-PM.png"
            alt="picture of doctor holding orange cat"
          />
        </div>
        ...
        <img
            className="imgpet2"
            src="https://i.postimg.cc/Gm4WfWv1/Screen-Shot-2024-06-05-at-2-22-32-PM.png"
            alt="picture of Pet MD owner profile"/>
        </div>
        <div className="pet4">
        <img
            className="imgpet"
            src="https://i.postimg.cc/nrxNnQxt/Screen-Shot-2024-06-05-at-2-19-58-PM.png"
            alt="picture of Pet MD sign up, lady holding a cat"/>
        </div>
        <div className="pet5">
        <img
            className="imgpet2"
            src="https://i.postimg.cc/T201DV4F/Screen-Shot-2024-06-05-at-2-16-46-PM.png"
            alt="picture of Pet MD sign up, lady holding a cat"/>
        </div>
